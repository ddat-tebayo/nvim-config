...
local function pick_color()
  local colors = { "RainbowDelimiterRed", "RainbowDelimiterYellow", "RainbowDelimiterGreen", "RainbowDelimiterBlue",
    "RainbowDelimiterCyan", "RainbowDelimiterViolet" }
...
dashboard.section.buttons.val = {
  ...
  button('RainbowDelimiterCyan', "f", "  Find file",
    ":cd $HOME/Workspace | Telescope find_files hidden=true path_display=smart<CR>"),
